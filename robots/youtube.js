...
async function robot() {
    ...
    async function authenticateWithOAuth() {
        ...
        await requesGoogleForAccessTokens(OAuthClient, authorizationToken)
        ...
        async function createOAuthClient() {
            ...
            const OAuthClient = new OAuth2(
                ...
                credentials.web.redirect_urls[0]
            )
        ...
        async function requesGoogleForAccessTokens(OAuthClient, authorizationToken) {
            return new Promise((resolve, reject) => {
    ...
    async function uploadVideo(content) {
        const videoPath = './content/output.mov'
